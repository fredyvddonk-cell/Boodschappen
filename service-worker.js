const CACHE_NAME='boodschappen-v4-1-pwa-1';
const APP_ASSETS=['./','./index.html','./style.css?v=4.1','./js/app.js?v=4.1','./js/shopping.js?v=4.1','./js/stock.js?v=4.1','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
