const CACHE_NAME='boodschappen-v4-2-pwa-1';
const APP_ASSETS=['./','./index.html','./style.css?v=4.2','./js/app.js?v=4.2','./js/shopping.js?v=4.2','./js/stock.js?v=4.2','./js/hutsel.js?v=4.2','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
